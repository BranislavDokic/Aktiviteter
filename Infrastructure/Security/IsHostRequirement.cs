...
public class IsHostRequirmentHandler(AppDbContext dbContext, IHttpContextAccessor httpContextAccessor) 
     : AuthorizationHandler<IsHostRequirement>
{
    protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context, IsHostRequirement requirement)
    {
        ...
        if (httpContex?.GetRouteValue("id") is not string activityId) return;  
